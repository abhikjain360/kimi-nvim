    ...
    "get_buffer_content",
    {
        ...
        inputSchema: {
            ...
            startLine: z
                .number()
                .optional()
                .describe("0-based start line (inclusive). Omit for full file."),
            endLine: z
                .number()
                .optional()
                .describe("0-based end line (exclusive). Omit for full file."),
        },
    },
...
mcpServer.registerTool(
    "open_file",
    {
        ...
        inputSchema: {
            filePath: z.string().describe("Absolute path to the file"),
            line: z.number().optional().describe("0-based line number to jump to"),
            column: z.number().optional().describe("0-based column number to jump to"),
        },
    },
